...
<div id="container">
    <h1>Products</h1>
    <div id="products">
        <div class="product"><img src="<?=base_url('public/images/')?>cowry-logo.jpg" alt="">
            Cowry Asset Management
            <div class="links">
                <a href="<?=base_url('admin/edit_product')?>"><img src="<?=base_url('public/images/')?>pencil.svg" alt=""></a>
                <a href="<?=base_url('admin/edit_product')?>"><img src="<?=base_url('public/images/')?>delete.svg" alt=""></a>
            </div>
        </div>
        <div class="split"></div>
        <div class="product"><img src="<?=base_url('public/images/')?>cowry-logo.jpg" alt="">
        ...
        <div class="split"></div><div class="product"><img src="<?=base_url('public/images/')?>cowry-logo.jpg" alt="">
            Cowry Asset Management
            <div class="links">
                <a href="<?=base_url('admin/edit_product')?>"><img src="<?=base_url('public/images/')?>pencil.svg" alt=""></a>
                <a href="<?=base_url('admin/edit_product')?>"><img src="<?=base_url('public/images/')?>delete.svg" alt=""></a>
